...
const TutorProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)]">
      ...
      <div className="max-w-4xl mx-auto px-2 -mt-20 pb-16">
        {/* Profile Card */}
          ...
          <div className="bg-[var(--bg-elevated)] rounded-2xl shadow-sm p-6 mb-6 border border-[var(--bg-border)]">
            ...
            <div className="flex flex-wrap gap-2">
              {(Array.isArray(tutor.subjects)
                ...
                <span
                  key={i}
                  className="bg-purple-100 dark:bg-purple-900/40 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 dark:text-purple-300 font-semibold px-2 py-2 rounded-xl text-sm"
                >
                  {s}
                </span>
              ))}
